...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BINLIBDEST': '/data/data/com.termux/files/usr/lib/python3.9',
 ...
 'BLDSHARED': 'aarch64-linux-android-clang -shared '
              ...
              '-L/home/builder/.termux-build/_cache/android-r21d-api-24-v3/sysroot/usr/lib '
              '-L/data/data/com.termux/files/usr/lib '
              '-Wl,-rpath=/data/data/com.termux/files/usr/lib -fopenmp '
              '-static-openmp -Wl,--enable-new-dtags -Wl,--as-needed '
              '-Wl,-z,relro,-z,now -landroid-support '
 ...
 'CONFIGURE_CPPFLAGS': '-I/data/data/com.termux/files/usr/include '
                       '-I/home/builder/.termux-build/_cache/android-r21d-api-24-v3/sysroot/usr/include',
 ...
 'CONFIG_ARGS': "'--disable-dependency-tracking' "
                ...
                "'ac_cv_func_gethostbyname_r=no' '--build=x86_64-pc-linux-gnu' "
                ...
                "'ac_cv_func_sem_unlink=no' '--disable-nls' '--enable-shared' "
                "'--enable-static' "
 ...
 'CONFINCLUDEPY': '/data/data/com.termux/files/usr/include/python3.9',
 'COREPYTHONPATH': '',
 ...
 'DESTLIB': '/data/data/com.termux/files/usr/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/data/data/com.termux/files/usr/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/data/data/com.termux/files/usr/include '
                   ...
                   '/data/data/com.termux/files/usr/include/python3.9 '
                   '/data/data/com.termux/files/usr/include/python3.9',
 'INCLUDEDIR': '/data/data/com.termux/files/usr/include',
 'INCLUDEPY': '/data/data/com.termux/files/usr/include/python3.9',
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/data/data/com.termux/files/usr/lib/python3.9',
 'LIBDIR': '/data/data/com.termux/files/usr/lib',
 ...
 'LIBPL': '/data/data/com.termux/files/usr/lib/python3.9/config-3.9',
 ...
 'LLVM_PROF_MERGER': '/home/builder/.termux-build/_cache/android-r21d-api-24-v3/bin/llvm-profdata '
                     'merge -output=code.profclangd *.profclangr',
 'LN': 'ln',
 'LOCALMODLIBS': '',
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/data/data/com.termux/files/usr/lib/python3.9',

...
#
# - BINSH
#   AC_REQUIRE'd #! /data/data/com.termux/files/usr/bin/sh line
# - HEADER-REVISION
#   RCS keywords etc.
# - HEADER-COMMENT
...
# /data/data/com.termux/files/usr/bin/sh.  This is OK because those shells will be rejected by
...
# /data/data/com.termux/files/usr/bin/sh bugs regarding the exit status.
m4_define([_AS_CASE],
[ [@%:@(]
  $1[)] :
    $2 ;;])
...
m4_if([$2], [], [: "${TMPDIR:=/data/data/com.termux/files/usr/tmp}"])
{
...
m4_divert_text([BINSH], [@%:@! /data/data/com.termux/files/usr/bin/sh])

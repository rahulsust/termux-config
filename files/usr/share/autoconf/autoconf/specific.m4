...
' >conftest
chmod u+x conftest
(SHELL=/data/data/com.termux/files/usr/bin/sh; export SHELL; ./conftest >/dev/null 2>&1)
if test $? -ne 69; then
...
#      /var/tmp		likewise
#      /usr/tmp		likewise
for ac_dir in . "$TMPDIR" /data/data/com.termux/files/usr/tmp "$prefix/lib" "$exec_prefix/lib"; do
